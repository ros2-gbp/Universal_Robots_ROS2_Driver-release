## ur_robot_driver (rolling) - 7.1.0-1

The packages in the `ur_robot_driver` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro rolling` on `Mon, 14 Sep 2026 14:08:17 -0000`
...
## ur_robot_driver (lyrical) - 6.1.0-1

The packages in the `ur_robot_driver` repository were released into the `lyrical` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro lyrical --edit` on `Mon, 14 Sep 2026 13:55:40 -0000`
...
## ur_robot_driver (lyrical) - 7.1.0-1

The packages in the `ur_robot_driver` repository were released into the `lyrical` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro lyrical` on `Mon, 14 Sep 2026 13:44:58 -0000`
...
## ur_robot_driver (kilted) - 4.9.0-1

The packages in the `ur_robot_driver` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro kilted` on `Mon, 14 Sep 2026 13:39:33 -0000`
...
## ur_robot_driver (jazzy) - 3.9.0-1

The packages in the `ur_robot_driver` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro jazzy` on `Mon, 14 Sep 2026 13:30:41 -0000`
...
## ur_robot_driver (humble) - 2.15.0-1

The packages in the `ur_robot_driver` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro humble` on `Mon, 14 Sep 2026 13:17:12 -0000`
...
## ur_robot_driver (humble) - 2.14.0-1

The packages in the `ur_robot_driver` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro humble` on `Wed, 22 Jul 2026 10:19:25 -0000`
...
## ur_robot_driver (kilted) - 4.8.0-1

The packages in the `ur_robot_driver` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro kilted` on `Fri, 10 Jul 2026 07:40:47 -0000`
...
## ur_robot_driver (rolling) - 7.0.0-1

The packages in the `ur_robot_driver` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro rolling` on `Fri, 10 Jul 2026 07:23:09 -0000`
...
## ur_robot_driver (humble) - 2.13.2-1

The packages in the `ur_robot_driver` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro humble` on `Thu, 25 Jun 2026 08:31:00 -0000`
...
## ur_robot_driver (humble) - 2.13.0-1

The packages in the `ur_robot_driver` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro humble` on `Thu, 09 Apr 2026 12:21:07 -0000`
...
## ur_robot_driver (jazzy) - 3.8.0-1

The packages in the `ur_robot_driver` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro jazzy` on `Thu, 09 Apr 2026 12:12:01 -0000`
...
## ur_robot_driver (kilted) - 4.6.0-1

The packages in the `ur_robot_driver` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro kilted --edit` on `Thu, 09 Apr 2026 11:58:30 -0000`
...
## ur_robot_driver (rolling) - 5.0.0-1

The packages in the `ur_robot_driver` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro rolling` on `Thu, 09 Apr 2026 11:28:36 -0000`
...
## ur_robot_driver (rolling) - 4.5.0-1

The packages in the `ur_robot_driver` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro rolling` on `Tue, 13 Jan 2026 16:33:59 -0000`
...
## ur_robot_driver (kilted) - 4.5.0-1

The packages in the `ur_robot_driver` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro kilted` on `Tue, 13 Jan 2026 16:04:48 -0000`
...
## ur_robot_driver (jazzy) - 3.7.0-1

The packages in the `ur_robot_driver` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro jazzy` on `Tue, 13 Jan 2026 15:49:05 -0000`
...
## ur_robot_driver (humble) - 2.12.0-1

The packages in the `ur_robot_driver` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro humble` on `Tue, 13 Jan 2026 15:32:50 -0000`
...
## ur_robot_driver (humble) - 2.11.0-1

The packages in the `ur_robot_driver` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro humble` on `Thu, 04 Dec 2025 15:10:38 -0000`
...
## ur_robot_driver (rolling) - 4.4.0-1

The packages in the `ur_robot_driver` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro rolling` on `Fri, 14 Nov 2025 07:38:41 -0000`
...
## ur_robot_driver (kilted) - 4.4.0-1

The packages in the `ur_robot_driver` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro kilted` on `Fri, 14 Nov 2025 07:30:38 -0000`
...
## ur_robot_driver (jazzy) - 3.6.0-1

The packages in the `ur_robot_driver` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro jazzy` on `Fri, 14 Nov 2025 07:01:33 -0000`
...
## ur_robot_driver (jazzy) - 3.5.0-1

The packages in the `ur_robot_driver` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro jazzy` on `Fri, 24 Oct 2025 10:42:40 -0000`
...
## ur_robot_driver (humble) - 2.10.0-1

The packages in the `ur_robot_driver` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro humble` on `Fri, 24 Oct 2025 07:59:28 -0000`
...
## ur_robot_driver (kilted) - 4.3.0-1

The packages in the `ur_robot_driver` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro kilted` on `Tue, 14 Oct 2025 11:16:13 -0000`
...
## ur_robot_driver (rolling) - 4.3.0-1

The packages in the `ur_robot_driver` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro rolling` on `Tue, 14 Oct 2025 10:06:49 -0000`
...
## ur_robot_driver (humble) - 2.9.0-1

The packages in the `ur_robot_driver` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro humble` on `Mon, 22 Sep 2025 08:09:15 -0000`
...
## ur_robot_driver (jazzy) - 3.4.0-1

The packages in the `ur_robot_driver` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro jazzy` on `Tue, 16 Sep 2025 10:58:02 -0000`
...
## ur_robot_driver (kilted) - 4.2.0-1

The packages in the `ur_robot_driver` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro kilted` on `Tue, 16 Sep 2025 10:39:11 -0000`
...
## ur_robot_driver (rolling) - 4.2.0-1

The packages in the `ur_robot_driver` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_robot_driver --rosdistro rolling` on `Tue, 16 Sep 2025 10:30:17 -0000`
...
## ur_robot_driver (kilted) - 4.1.0-1

The packages in the `ur_robot_driver` repository were released into the `kilted` distro by running `/home/feex/Downloads/bloom/venv/bin/bloom-release ur_robot_driver --rosdistro kilted --no-pull-request` on `Tue, 29 Jul 2025 11:59:27 -0000`
...
## ur_robot_driver (rolling) - 4.1.0-1

The packages in the `ur_robot_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release ur_robot_driver --rosdistro rolling --no-pull-request` on `Tue, 29 Jul 2025 10:55:29 -0000`
...
## ur_robot_driver (jazzy) - 3.3.3-1

The packages in the `ur_robot_driver` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release ur_robot_driver --rosdistro jazzy` on `Wed, 25 Jun 2025 06:46:49 -0000`
...
## ur_robot_driver (rolling) - 4.0.3-1

The packages in the `ur_robot_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release ur_robot_driver --rosdistro rolling` on `Mon, 16 Jun 2025 08:40:53 -0000`
...
## ur_robot_driver (kilted) - 4.0.3-1

The packages in the `ur_robot_driver` repository were released into the `kilted` distro by running `/usr/bin/bloom-release ur_robot_driver --rosdistro kilted` on `Mon, 16 Jun 2025 07:36:45 -0000`
...
## ur_robot_driver (rolling) - 4.0.2-1

The packages in the `ur_robot_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release ur_robot_driver --rosdistro rolling` on `Fri, 13 Jun 2025 14:03:22 -0000`
...
## ur_robot_driver (kilted) - 4.0.2-1

The packages in the `ur_robot_driver` repository were released into the `kilted` distro by running `/usr/bin/bloom-release ur_robot_driver --rosdistro kilted` on `Fri, 13 Jun 2025 11:39:35 -0000`
...
The packages in the `ur_robot_driver` repository were released into the `humble` distro by running `/usr/bin/bloom-release ur_robot_driver --rosdistro humble` on `Wed, 11 Jun 2025 07:07:50 -0000`
...
The packages in the `ur_robot_driver` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release ur_robot_driver --rosdistro jazzy` on `Wed, 11 Jun 2025 06:43:21 -0000`
